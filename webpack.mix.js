...
mix.
    ...
    copy(gentelella_home + 'build/css/custom.min.css',
        public_css + 'gentelella-custom.min.css').
    ...
    copy(gentelella_vendor + 'bootstrap/dist/js/bootstrap.bundle.min.js',
        public_js + 'bootstrap.bundle.min.js').
    // font-awesome
    copy(gentelella_vendor + 'font-awesome/css/font-awesome.min.css',
        public_css + 'font-awesome.min.css').
    copy(gentelella_vendor + 'font-awesome/css/font-awesome.css.map',
        public_css + 'font-awesome.css.map').
    copy(gentelella_vendor + 'font-awesome/js/all.min.js',
        public_js + 'all.min.js').
    // nprogress
    ...
    copy(gentelella_vendor +
        ...
        public_css + 'bootstrap-progressbar.min.css').
    copy(gentelella_vendor + 'bootstrap-progressbar/bootstrap-progressbar.min.js',
        public_js + 'bootstrap-progressbar.min.js').
    ...
    copy(gentelella_vendor + 'chart.js/dist/Chart.min.js',
        public_js + 'chart.min.js').
    copy(gentelella_vendor + 'gauge.js/dist/gauge.min.js',
        public_js + 'gauge.min.js').
    ...
    copy(gentelella_vendor + 'Flot/jquery.flot.resize.js',
        public_js + 'jquery.flot.resize.js').
    copy(gentelella_vendor + 'flot-spline/js/jquery.flot.spline.min.js',
        public_js + 'jquery.flot.spline.min.js').
